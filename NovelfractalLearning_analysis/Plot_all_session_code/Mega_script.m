...
% load data:
%Monkey S
load('neuronliststruct_Slayer_simplified.mat');
%Monkey L
load('neuronliststruct_Lemmy_simplified.mat');
...
% heatmap figure
heatmapplot_func(indices, plotpath, {});
...
% this is a fun analysis related to Murray et. al., 2014
time_scale_check;

...
load(fullfile('..\Plot_all_session_code','neuronliststruct_all'), 'Neuronlist_good', 'Neuronlist_even', 'Neuronlist_odd');
allfieldnames = fieldnames(Neuronlist_good);
fieldname_2_include = {'name';'electrodeID'; 'electrodeDepth'; 'ISIviolationrate'; 'unitQuality'; 'contaminationRate'; 'exclude'; 'excludemua';
'recency_ind_match_pos'; 'P_recency_ind_match_pos'; 'pred_nov_vs_fam'; 'P_pred_nov_vs_fam';
'pred_vs_unpred_fam'; 'P_pred_vs_unpred_fam_perm'; 'violation_ind'; 'P_violation_ind_perm';
'pred_nov_vs_fam_control1'; 'pred_nov_vs_fam_control2';
'P_pred_nov_vs_fam_control1'; 'P_pred_nov_vs_fam_control2';
...
% 'zscoremean_info'; 'zscorestd_info'; 'zscoremean'; 'zscorestd'; 
...
save(fullfile('..\Plot_all_session_code','neuronliststruct_Lemmy_simplified'), 'Neuronlist_Slayer');
save(fullfile('..\Plot_all_session_code','neuronliststruct_Slayer_simplified'), 'Neuronlist_Lemmy');
